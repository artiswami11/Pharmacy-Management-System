...
public class Tables {
    ...
    public static void main(String[] args) {
        try {
            ...
            //  st.executeUpdate("insert into appuser (userRole,name,dob,mobileNumber,email,username,password,address) values('Admin','Admin','11-06-2003','8600631383','admin@email.com','admin','admin', 'India')");
